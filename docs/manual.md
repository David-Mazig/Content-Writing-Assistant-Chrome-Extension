...
![Popup — New Content](screenshots/ext-popup-1.png)
...
![Test-image-in-table — Test Case 1: Product Catalog](screenshots/ext-test-image-in-table-1.png)
...
![Test-image-in-table — Test Case 2: Team Directory](screenshots/ext-test-image-in-table-2.png)
...
![Test-image-in-table — Test Case 3: Mixed Content Table](screenshots/ext-test-image-in-table-3.png)
